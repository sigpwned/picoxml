...
public class XMLUtil {
   ...
   */
  public static void skipComment(IXMLReader reader) throws IOException, XMLParseException {
    if (reader.read() != '-') {
   ...
   * @throws java.io.IOException if an error occurred reading the data
   */
  public static void skipTag(IXMLReader reader) throws IOException, XMLParseException {
    int level = 1;
   ...
   * @throws java.io.IOException if an error occurred reading the data
   */
  public static String scanPublicID(StringBuffer publicID, IXMLReader reader)
   ...
   * @throws java.io.IOException if an error occurred reading the data
   */
  public static String scanSystemID(IXMLReader reader) throws IOException, XMLParseException {
   ...
   * @throws java.io.IOException if an error occurred reading the data
   */
  public static String scanString(IXMLReader reader, char entityChar,
   ...
   * @throws java.io.IOException if an error occurred reading the data
   */
  public static void processEntity(String entity, IXMLReader reader,
      IXMLEntityResolver entityResolver) throws IOException, XMLParseException {
   ...
   * @throws java.io.IOException if an error occurred reading the data
   */
  public static String read(IXMLReader reader, char entityChar)
      throws IOException, XMLParseException {
    char ch = reader.read();
   ...
   * @param entityChar the escape character (&amp; or %) used to indicate an entity
   */
  public static char readChar(IXMLReader reader, char entityChar)
      throws IOException, XMLParseException {
    String str = XMLUtil.read(reader, entityChar);
    char ch = str.charAt(0);
   ...
   * @throws java.io.IOException if an error occurred reading the data
   */
  public static boolean checkLiteral(IXMLReader reader, String literal)
      throws IOException, XMLParseException {
  ...
  /**
   * Throws an LiteXmlParseException to indicate that an expected string is not encountered.
   *
   ...
   */
  public static void errorExpectedInput(String systemID, int lineNr, String expectedString)
  ...
  /**
   * Throws an LiteXmlParseException to indicate that an entity could not be resolved.
   *
   * @param systemID the system ID of the data source
   * @param lineNr the line number in the data source
   * @param entity the name of the entity
   */
  public static void errorInvalidEntity(String systemID, int lineNr, String entity)
      throws XMLParseException {
  ...
  /**
   * Throws an LiteXmlParseException to indicate that an entity reference is unexpected at this
   * point.
   *
   * @param systemID the system ID of the data source
   * @param lineNr the line number in the data source
   * @param entity the name of the entity
   */
  public static void errorUnexpectedEntity(String systemID, int lineNr, String entity)
      throws XMLParseException {
    throw new XMLParseException(systemID, lineNr,
        "No entity reference is expected here (" + entity + ")");
  }


  /**
   * Throws an LiteXmlParseException to indicate that a CDATA section is unexpected at this point.
   *
   * @param systemID the system ID of the data source
   * @param lineNr the line number in the data source
   */
  public static void errorUnexpectedCDATA(String systemID, int lineNr) throws XMLParseException {
    throw new XMLParseException(systemID, lineNr, "No CDATA section is expected here");
  }


  /**
   * Throws an LiteXmlParseException to indicate that a string is not expected at this point.
   *
   * @param systemID the system ID of the data source
   * @param lineNr the line number in the data source
   * @param unexpectedString the string that is unexpected
   */
  public static void errorInvalidInput(String systemID, int lineNr, String unexpectedString)
      throws XMLParseException {
  ...
  /**
   * Throws an LiteXmlParseException to indicate that the closing tag of an element does not match
   * the opening tag.
   *
   * @param systemID the system ID of the data source
   * @param lineNr the line number in the data source
   ...
   */
  public static void errorWrongClosingTag(String systemID, int lineNr, String expectedName,
      String wrongName) throws XMLParseException {
    throw new XMLParseException(systemID, lineNr,
        "Closing tag does not match opening tag: `" + wrongName + "' != `" + expectedName + "'");
  }


  /**
   * Throws an LiteXmlParseException to indicate that extra data is encountered in a closing tag.
   *
   * @param systemID the system ID of the data source
   * @param lineNr the line number in the data source
   */
  public static void errorClosingTagNotEmpty(String systemID, int lineNr) throws XMLParseException {
   ...
   */
  public static void errorMissingElement(String systemID, int lineNr, String parentElementName,
    ...
    throw new XMLValidationException(XMLValidationException.MISSING_ELEMENT, systemID, lineNr,
        missingElementName, /* attributeName */ null, /* attributeValue */ null,
        "Element " + parentElementName + " expects to have a " + missingElementName);
  }
   ...
   */
  public static void errorUnexpectedElement(String systemID, int lineNr, String parentElementName,
    ...
    throw new XMLValidationException(XMLValidationException.UNEXPECTED_ELEMENT, systemID, lineNr,
        unexpectedElementName, /* attributeName */ null, /* attributeValue */ null,
        "Unexpected " + unexpectedElementName + " in a " + parentElementName);
  }
   ...
   */
  public static void errorMissingAttribute(String systemID, int lineNr, String elementName,
      String attributeName) throws XMLValidationException {
    throw new XMLValidationException(XMLValidationException.MISSING_ATTRIBUTE, systemID, lineNr,
        elementName, attributeName, /* attributeValue */ null,
        "Element " + elementName + " expects an attribute named " + attributeName);
  }
   ...
   */
  public static void errorUnexpectedAttribute(String systemID, int lineNr, String elementName,
      String attributeName) throws XMLValidationException {
    throw new XMLValidationException(XMLValidationException.UNEXPECTED_ATTRIBUTE, systemID, lineNr,
        elementName, attributeName, /* attributeValue */ null,
        "Element " + elementName + " did not expect an attribute " + "named " + attributeName);
  }
   ...
   */
  public static void errorInvalidAttributeValue(String systemID, int lineNr, String elementName,
      String attributeName, String attributeValue) throws XMLValidationException {
    throw new XMLValidationException(XMLValidationException.ATTRIBUTE_WITH_INVALID_VALUE, systemID,
        lineNr, elementName, attributeName, attributeValue,
   ...
   * @param parentElementName the name of the parent element
   */
  public static void errorMissingPCData(String systemID, int lineNr, String parentElementName)
      throws XMLValidationException {
    throw new XMLValidationException(XMLValidationException.MISSING_PCDATA, systemID, lineNr,
        /* elementName */ null, /* attributeName */ null, /* attributeValue */ null,
   ...
   * @param parentElementName the name of the parent element
   */
  public static void errorUnexpectedPCData(String systemID, int lineNr, String parentElementName)
      throws XMLValidationException {
   ...
   * @param attributeValue the value of that attribute
   */
  public static void validationError(String systemID, int lineNr, String message,
