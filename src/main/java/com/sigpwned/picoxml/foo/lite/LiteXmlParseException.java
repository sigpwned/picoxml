...
/**
 * An LiteXmlParseException is thrown when an error occures while parsing an XML
 * string.
 * <P>
 * $Revision: 1.4 $<BR>
 * $Date: 2002/03/24 10:27:59 $<P>
 *
 * @see LiteXmlElement.DefaultXmlElement
 *
 */
    ...
    extends RuntimeException
{
     ...
     * </ul></dd></dl><dl>
     */
    public LiteXmlParseException(String name,
                             String message)
    {
        super("XML Parse Exception during parsing of "
              + ((name == null) ? "the XML definition"
                                : ("a " + name + " element"))
              + ": " + message);
        this.lineNr = LiteXmlParseException.NO_LINE;
    }
     ...
     * unknown.
     *
     * @see LiteXmlParseException.XMLParseException#NO_LINE
     */
