...
import com.sigpwned.picoxml.foo.XMLParserFactory;
import com.sigpwned.picoxml.foo.impl.DefaultXmlReader;
   ...
   implements Parser
{
             ...
             IOException
   {
      ...
      if (reader != null) {
         parser.setReader(new DefaultXmlReader(reader));
      } else {
         ...
         if (stream != null) {
            ...
            if (encoding != null) {
               ...
               parser.setReader(new DefaultXmlReader(stream));
            }
         } else { // if stream == null
            parser.setReader(new DefaultXmlReader(source.getPublicId(),
                                              source.getSystemId()));
         }
      }
             ...
             IOException
   {
      IXMLParser parser = this.createParser();
      parser.setBuilder(this.adapter);
      parser.setReader(new DefaultXmlReader(null, systemId));
