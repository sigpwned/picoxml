...
import com.sigpwned.picoxml.foo.XMLParseException;


/**
 * DefaultXmlBuilder is a concrete implementation of IXMLBuilder which creates a
   ...
   implements IXMLBuilder
{
    ...
    */
   public DefaultXmlBuilder(IXMLElement prototype)
   {
      this.stack = null;
      this.root = null;
    ...
    *
    * @see com.sigpwned.picoxml.foo.IXMLParser#parse
    *
