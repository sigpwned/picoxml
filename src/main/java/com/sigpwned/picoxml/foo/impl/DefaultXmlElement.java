 ...
 * ==================================LICENSE_END===================================
 */
package com.sigpwned.picoxml.foo.impl;
...
import com.sigpwned.picoxml.foo.IXMLElement;
import com.sigpwned.picoxml.foo.XMLAttribute;


/**
 * LiteXmlElement is an XML element. The standard NanoXML builder generates a tree of such elements.
 *
 * @see DefaultXmlBuilder.n3.nanoxml.StdXMLBuilder
 *
 */
public class DefaultXmlElement implements IXMLElement, Serializable {
   ...
   */
  public DefaultXmlElement(String fullName) {
   ...
   */
  public DefaultXmlElement(String fullName, String systemID, int lineNr) {
   ...
   */
  public DefaultXmlElement(String fullName, String namespace) {
   ...
   * @param lineNr the line in the XML data where the element starts.
   */
  public DefaultXmlElement(String fullName, String namespace, String systemID, int lineNr) {
  ...
  public IXMLElement createElement(String fullName) {
    return new DefaultXmlElement(fullName);
  }
  ...
  public IXMLElement createElement(String fullName, String systemID, int lineNr) {
    return new DefaultXmlElement(fullName, systemID, lineNr);
  }
  ...
  public IXMLElement createElement(String fullName, String namespace) {
    return new DefaultXmlElement(fullName, namespace);
  }
  ...
  public IXMLElement createElement(String fullName, String namespace, String systemID, int lineNr) {
    return new DefaultXmlElement(fullName, namespace, systemID, lineNr);
  }
   ...
   *
   * @return the namespace, or null if no namespace is associated with the element.
   */
  @Override
  ...
  public void addChild(IXMLElement child) {
    ...
    ((DefaultXmlElement) child).parent = this;
  ...
  public IXMLElement getFirstChildNamed(String name) {
    ...
    while (iter.hasMoreElements()) {
      IXMLElement child = (IXMLElement) iter.nextElement();
  ...
  private XMLAttribute findAttribute(String fullName) {
    Enumeration iter = this.attributes.elements();
    while (iter.hasMoreElements()) {
      XMLAttribute attr = (XMLAttribute) iter.nextElement();
   ...
   *             {@link #getAttribute(java.lang.String,java.lang.String)} Returns the value of an
   *             attribute.
   *
