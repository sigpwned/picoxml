...
/**
 * This reader reads data from another reader until the end of a CDATA section (]]&gt;) has been
 * encountered.
 *
 */
public class CDATAReader extends Reader {
   ...
   */
  public CDATAReader(IXMLReader reader) {
    this.reader = reader;
    this.savedChar = 0;
